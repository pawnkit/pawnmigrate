...
The YSI migration changes only manifest references. It does not rewrite source
code or claim that unrelated YSI forks are compatible with the official 5.x
repository.
